...
class NodeInfoPanel(ctk.CTkFrame):
    ...
    def show_order(self, alg_name, order, graph):
        ...
        ctk.CTkLabel(list_header, text="Adım", font=("Roboto", 11, "bold"), text_color="#95a5a6").pack(side="left",
                                                                                                       padx=15)
        ctk.CTkLabel(list_header, text="Ziyaret Edilen Düğüm", font=("Roboto", 11, "bold"), text_color="#95a5a6").pack(
            side="right", padx=15)
